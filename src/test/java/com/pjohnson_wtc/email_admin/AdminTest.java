...
public class AdminTest {
	...
	public void testCreateNewHire_passwordAutoGenerated() {
		admin.createNewHire("John", "Wayne", null);
		assertNotNull(admin.getAllNewHires().get(0).getPassword());
	}
	@Test
	...
	public void testSetAlternateEmail_incorrectFormat() {
		admin.createNewHire("John", "Wayne", null);
		admin.getAllNewHires().get(0).setAlternateEmail("dummy");
		assertNull(admin.getAllNewHires().get(0).getAlternateEmail());
	}
	@Test
	public void testSetAlternateEmail_incorrectFormat_tooShort() {
		admin.createNewHire("John", "Wayne", null);
		admin.getAllNewHires().get(0).setAlternateEmail("@.");
		assertNull(admin.getAllNewHires().get(0).getAlternateEmail());
	}
	@Test
	public void testSetAlternateEmail_incorrectFormat_specialCharsAtEnd() {
		admin.createNewHire("John", "Wayne", null);
		admin.getAllNewHires().get(0).setAlternateEmail("dummy@.");
		assertNull(admin.getAllNewHires().get(0).getAlternateEmail());
	}
	@Test
	public void testSetAlternateEmail_incorrectFormat_specialCharsAtStart() {
		admin.createNewHire("John", "Wayne", null);
		admin.getAllNewHires().get(0).setAlternateEmail(".dummy");
		assertNull(admin.getAllNewHires().get(0).getAlternateEmail());
	}
	...
	public void testSetMailboxCapacity_numberZeroOrLess() {
		admin.createNewHire("John", "Wayne", null);
		admin.getAllNewHires().get(0).setMailboxCapacity(-10);
		assertEquals(2000000, admin.getAllNewHires().get(0).getMailboxCapacity());
	}
	@Test
